Flow JSON Cache [![License](http://img.shields.io/badge/license-MIT-lightgrey.svg?style=flat)][License] [![Flattr this](http://img.shields.io/badge/flattr-donate-lightgrey.svg?style=flat)][Donate] [![Build Status](http://img.shields.io/travis/flow/flow-json-cache/master.svg?style=flat)](https://travis-ci.org/flow/flow-json-cache) [![Coverage Status](http://img.shields.io/coveralls/flow/flow-json-cache/master.svg?style=flat)](https://coveralls.io/r/flow/flow-json-cache)
==================
...
## Getting Started
* [Examples and code snippets](https://github.com/flow/examples/tree/master/json-cache)
* [Official documentation](#documentation)
* [IRC support chat](http://kiwiirc.com/client/irc.esper.net/flow)
* [Issues tracker](https://github.com/flow/flow-json-cache/issues)

## Source Code
The latest and greatest source can be found here on [GitHub](https://github.com/flow/flow-json-cache). If you are using Git, use this command to clone the project:

    git clone git://github.com/flow/flow-json-cache.git

Or download the [latest zip archive](https://github.com/flow/flow-json-cache/archive/master.zip).
...
* [joda-time:joda-time](https://oss.sonatype.org/#nexus-search;gav~joda-time~joda-time~~~)
...
If you'd prefer to manually import the latest .jar file, you can get it [here](https://github.com/flow/flow-json-cache/releases).

## Documentation
Want to get friendly with the project and put it to good use? Check out the latest [Javadocs](http://json-cache.flowpowered.com/).
...
## Legal Stuff
Flow JSON Cache is licensed under the [MIT License][License]. Basically, you can do whatever you want as long as you include the original copyright. Please see the `LICENSE.txt` file for details.
